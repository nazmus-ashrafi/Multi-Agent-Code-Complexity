...
# MAX_RETRIES_BLOCK = 2  # means 3 times max retries, passes executioner node 4 times 

MAX_RETRIES_BLOCK = 9 # means 10 times max retries, passes executioner node 11 times  # DEFAULT
...
class Debugger_Only_Flow(object):
    ...
    def __init__(self, CODER_MAIN, CODER_IMPROVER, ANALYST, TESTER,
        ...
        if provider == "HuggingFace":
            ...
            # eg - 8. model = ChatOpenAI(model_name="gpt-3.5-turbo-0125", temperature=0)
            ...
            # 14.  eg - model = ChatGroq(temperature=0,
    ...
    def run_flow(self):
        ...
        def simple_text2code(state: GraphState):
            ...
            naivecode = self.coder_main.implement(function_description=requirement)
        ...
        workflow.set_entry_point("simple_text2code")
