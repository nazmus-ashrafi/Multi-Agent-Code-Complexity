...
class Flow(object):
    def __init__(self, PYTHON_DEVELOPER,
    ...
    def run_flow(self):
        ...
        def simple_text2code(state):
            naivecode = self.coder.implement(function_description = self.requirement)
