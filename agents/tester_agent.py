...
class TesterAgent:
    ...
    def construct_prompt(self):
        ...
        return PromptTemplate.from_template('''I want you to act as a tester in the team. You will receive the code written by the developer, and your job is to complete a report as follows:
