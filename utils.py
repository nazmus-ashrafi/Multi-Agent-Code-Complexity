...
def clean_code_function(original_code: str) -> str:
    """
    Remove outer Markdown code fences while preserving valid Python syntax,
    including docstrings and multi-line strings.
    """
    ...
    # Case 1: The whole response is wrapped in a Markdown code fence.
    ...
    # Case 2: The response contains explanation plus one Python code block.
    ...
    if embedded_match:
        return embedded_match.group("code").strip()

    # Case 3: No Markdown fence; return as-is.
    return code
